...
function activate(context: vscode.ExtensionContext) {
	...
	function cssFormatFun(types: string) {
	...
	var cssCodeFormat = {
		...
		cssFormatCompactExpand(str: string) {
			var code = str;
		...
		cssComm(action: string, str: string) {
			// Protect comments
